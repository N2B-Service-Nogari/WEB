...
function Privacy() {
  return (
    <div style={{ padding: '2rem' }}>
      <p>
        <em>
          {'<'} nogari206{'>'}(&apos;https://www.nogari.me/&apos;이하
          &apos;Nogari&apos;)
        </em>
      ...
      <p>
        ○ 이 개인정보처리방침은 <em>2023</em>년 <em>5</em>월 <em>13</em>부터
        적용됩니다.
      </p>
      <br />
      <p>
      ...
      <p>
        ...
        은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를
      ...
      <p>
        <br />① {'<'} nogari206{'>'} 은(는) 개인정보 보유기간의 경과, 처리목적
        ...
        1. 파기절차
        <br />
        {'<'} nogari206{'>'} 은(는) 파기 사유가 발생한 개인정보를 선정하고,{' '}
        {'<'} nogari206{'>'} 의 개인정보 보호책임자의 승인을 받아 개인정보를
        파기합니다.
        <br />
      </p>
      <p>2. 파기방법</p>
      ...
      <p>
        <br />
        <br />① 정보주체는 nogari206에 대해 언제든지 개인정보
        열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
      </p>
      <p>
        ② 제1항에 따른 권리 행사는nogari206에 대해 「개인정보 보호법」 시행령
        제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
        있으며 nogari206은(는) 이에 대해 지체 없이 조치하겠습니다.
      </p>
      <p>
      ...
      <p>
        ⑥ nogari206은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
      ...
      <p>
        ...
        <br />
        2. 접속기록의 보관 및 위변조 방지
        <br /> 개인정보처리시스템에 접속한 기록을 최소 1년 이상 보관, 관리하고
      ...
      <br />
      <br />① nogari206 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
      이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.
      <br />② 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 컴퓨터
      ...
      <p>
        {' '}
        ① <span>nogari206</span> 은(는) 개인정보 처리에 관한 업무를 총괄해서
      ...
      <ul>
        ...
        <li>직책 :FE Manager</li>
        <li>직급 :CFO</li>
        <li>연락처 :010-0000-0000, nogari206@gmail.com, </li>
      </ul>
      <p>
        ※ 개인정보 보호 담당부서로 연결됩니다.
        <p />
        <p>
          ② 정보주체께서는 nogari206 의 서비스(또는 사업)을 이용하시면서 발생한
          모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
          개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. nogari206
        ...
        <p>
          <strong>
            ...
            <br />
            {'<'} nogari206{'>'}은(는) 정보주체의 개인정보 열람청구가 신속하게
            처리되도록 노력하겠습니다.
          </strong>
        </p>
        <br />
      ...
      <p>① 이 개인정보처리방침은 2023년 5월 13부터 적용됩니다.</p>
      <br /> <br /> <br /> <br />
    </div>
  )
}
